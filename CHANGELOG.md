...
- Multi-stage `Dockerfile` (Node 22 + Composer 2 + PHP 8.3-FPM + nginx + supervisord) with parameterised `ARG` versions
...
- PHP static analysis with [PHPStan](https://phpstan.org/) level 5 + [phpstan-wordpress](https://github.com/szepeviktor/phpstan-wordpress) stubs (`phpstan.neon`)
